...
## Project Structure
    ...
    ├── testapiautodatamod_101764  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_101764`
...
2. Clone this repo and `cd testapiautodatamod_101764`
